...
export function HeroSection() {
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-bold gradient-text">इंस्टाग्राम कंटेंट जनरेटर</h1>
      <p className="text-xl text-muted-foreground">
        AI-पावर्ड टूल्स जो आपको बनाने में मदद करेंगे आकर्षक कैप्शन, प्रोफेशनल बायो और ट्रेंडिंग हैशटैग
      </p>

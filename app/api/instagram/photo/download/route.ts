...
function extractMediaUrl(responseData: MediaResponse): string | null {
  ...
  try {
    ...
    try {
      ...
      const contentType = mediaResponse.headers['content-type'] || 
        (mediaUrl.includes('.mp4') ? 'video/mp4' : 'image/jpeg')
      ...
      return new NextResponse(mediaResponse.data, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="instagram-${isVideo ? 'video' : 'photo'}.${extension}"`,
      ...
      if (apiError.response) {
        ...
        switch (statusCode) {
          ...
          case 403:
            ...
            break
          case 404:
            errorMessage = 'Media not found or is private'
            break
          case 429:
